...
fingerprint_dict = model.load_pickle('bin/Debug/net9.0/python_embedded/python_code/DLKcat/DeeplearningApproach/Data/input/fingerprint_dict.pickle')
atom_dict = model.load_pickle('bin/Debug/net9.0/python_embedded/python_code/DLKcat/DeeplearningApproach/Data/input/atom_dict.pickle')
bond_dict = model.load_pickle('bin/Debug/net9.0/python_embedded/python_code/DLKcat/DeeplearningApproach/Data/input/bond_dict.pickle')
edge_dict = model.load_pickle('bin/Debug/net9.0/python_embedded/python_code/DLKcat/DeeplearningApproach/Data/input/edge_dict.pickle')
word_dict = model.load_pickle('bin/Debug/net9.0/python_embedded/python_code/DLKcat/DeeplearningApproach/Data/input/sequence_dict.pickle')
...
def main() :
    name = 'bin/Debug/net9.0/python_embedded/python_code/DLKcat/DeeplearningApproach/Code/example/input.tsv'
    print(name)
    ...
    Kcat_model.load_state_dict(torch.load('bin/Debug/net9.0/python_embedded/python_code/DLKcat/DeeplearningApproach/Results/output/1.5--decay_interval10--weight_decay1e-6--iteration50', map_location=device))
